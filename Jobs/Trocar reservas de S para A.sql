...
/****** Object:  Job [Trocar reservas de S para A]    Script Date: 11/19/2014 10:18:20 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 11/19/2014 10:18:20 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Trocar reservas de S para A', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [UPDATE]    Script Date: 11/19/2014 10:18:21 ******/
