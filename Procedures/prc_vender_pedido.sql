...
@CAIXA = CASE WHEN ID_USUARIO_CALLCENTER IS NOT NULL
...
BEGIN
	...
	SET @query = N'EXEC '+CONVERT(NVARCHAR,@DS_NOME_BASE_SQL)+N'..SP_VEN_INS001_WEB @ID_SESSION_IN, @ID_BASE_IN, @CD_MEIO_PAGAMENTO_IN, @CODAPRESENTACAO_IN,
																					...
																					@CD_NUMERO_AUTORIZACAO_IN, @CD_BIN_CARTAO_IN, @CAIXA_IN, @RETURN_CODE_OUT OUTPUT'
	...
	BEGIN
		...
		SET @ERROR_MSG = 'ERRO NA EXECUÇÃO DA PROCEDURE SP_VEN_INS001_WEB PARA O PEDIDO ' + CONVERT(VARCHAR,@ID_PEDIDO_VENDA)
...
begin catch
	...
	INSERT INTO tab_log_gabriel (data, passo, parametros) VALUES (GETDATE(), 'ERRO', left(ERROR_MESSAGE(), 500))

  	SET NOCOUNT OFF
	SELECT 0 AS Resultado, ERROR_MESSAGE() AS Error_Msg
