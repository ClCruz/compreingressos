...
if (isset($_GET['action'])) {
	...
	$result = executeSQL($mainConnection, 'SELECT ID_MEIO_PAGAMENTO, CODFORPAGTO, DS_FORPAGTO FROM MW_MEIO_PAGAMENTO_FORMA_PAGAMENTO WHERE ID_BASE = ?', array($_GET['teatro']));
