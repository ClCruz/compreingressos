...
?>
        ...
        <table width="900" border="0" bgcolor="<?php echo (!isset($_GET["exportar"])) ? "LightGrey" : ""; ?>" class="tabela">
            <tr height="15">
...
?>
				<br clear=all>
                <br clear=all>
                <table width="900" class="tabela" border="0" bgcolor="<?php echo (!isset($_GET["exportar"])) ? "LightGrey" : ""; ?>">
                    <tr>
...
?>	
            ...
            <br clear="all">
			<table name="tab" id="tab" style="width: 900px; " border=0 bgcolor="<?php echo (!isset($_GET["exportar"])) ? "LightGrey" : ""; ?>" class="tabela">
                <tr>
...
<?php		
						...
						if($nLin > 35){
							...
							if(!isset($_GET["exportar"]))
								...
								echo "<table width=\"900\" border=\"0\" class=\"tabela\">";
