<div id="footer">
	<div class="centraliza">
		<ul>
			...
			<li><a href="http://compreingressos.com/especiais/2-Agendamento_de_Grupos">Vendas para grupos</a></li>
		...
		<ul>
			...
			<li><a href="https://compreingressos.webdesklw.com.br/user_sessions/new" target="_blank">Sac & Suporte</a></li>
		...
		<ul>
			...
			<li><a href="http://www.facebook.com/compreingressos" target="_blank" class="facebook">Seja nosso fã<br> no facebook</a></li>
			<li><a href="http://twitter.com/compreingressos" target="_blank" class="twitter">Siga-nos<br> no twitter</a></li>
		</ul>
	</div>
</div>