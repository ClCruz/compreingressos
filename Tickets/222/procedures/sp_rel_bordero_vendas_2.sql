...
GO
CREATE  PROCEDURE [dbo].[SP_REL_BORDERO_VENDAS_2]
(
	@CodPeca   int, 
	@CodApresentacao int, 
...
CREATE    PROCEDURE [dbo].[SP_REL_BORDERO_VENDAS_2];2
	@DtIniApr varchar(8), 
	@DtFimApr varchar(8), 
	@codPeca int = null,
...
SET QUOTED_IDENTIFIER ON
GO
CREATE    PROCEDURE [dbo].[SP_REL_BORDERO_VENDAS_2];3
	@DtIniApr varchar(8), 
	@DtFimApr varchar(8), 
	@codPeca int = null,
	@codSala int = null, 
...
SET QUOTED_IDENTIFIER ON
GO
CREATE  procedure [dbo].[SP_REL_BORDERO_VENDAS_2];4
 	@CodApresentacao int,
	@DataBase varchar(30)
AS
...
CREATE  procedure [dbo].[SP_REL_BORDERO_VENDAS_2];5
	@DtIniApr varchar(8),
	@DtFimApr varchar(8), 
