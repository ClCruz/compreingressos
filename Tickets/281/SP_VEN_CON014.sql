...
DROP PROCEDURE DBO.SP_VEN_CON014
GO
/*
+=================================================================================================================+'
...
CREATE PROCEDURE DBO.SP_VEN_CON014 (
	@CODSALA    SMALLINT,
	@CODPECA    SMALLINT,	
...
SELECT
	CONVERT(VARCHAR, DATAPRESENTACAO, 103) AS DATA_APRESENTACAO,
	HORSESSAO,
	COUNT(1) AS QTDE,
	SUM(PRECO) AS PAGTO,	
...
FROM
	#TMP_RESUMO
GROUP BY
	CONVERT(VARCHAR, DATAPRESENTACAO, 103), 		
	HORSESSAO,
	DS_CANAL_VENDA
ORDER BY	
	CONVERT(VARCHAR, DATAPRESENTACAO, 103),
