	...
	<div id="background_holder">
		...
		<div id="content_container">
			...
			<div id="center_right">
				...
				<a href="etapa4.php?eventoDS=<?php echo $_GET['eventoDS']; ?><?php echo $campanha['tag_voltar']; ?>">
...
<?php } else { ?>
    				<a href="etapa5.php?eventoDS=<?php echo $_GET['eventoDS']; ?><?php echo $campanha['tag_voltar']; ?>" id="botao_avancar" class="botao_avancar">
    				    <div class="botoes_ticket">tentar novamente</div>
    				</a>
    				<a href="etapa2.php?eventoDS=<?php echo $_GET['eventoDS']; ?><?php echo $campanha['tag_voltar']; ?>" style="margin-right:15px;" id="botao_avancar" class="botao_avancar">
