...
SELECT CONVERT(VARCHAR, DATAPRESENTACAO, 112) AS DATA_APRESENTACAO
	,HORSESSAO
	,DBO.GETQTDEEXCEDENTES(DATAPRESENTACAO, HORSESSAO, @QTDLIMITEINGRPARAVENDA) AS QTDE
	,(DBO.GETQTDEEXCEDENTES(DATAPRESENTACAO, HORSESSAO, @QTDLIMITEINGRPARAVENDA) * @VALINGRESSOEXCEDENTE) * - 1 AS PAGTO
