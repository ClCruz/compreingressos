...
if (acessoPermitido($mainConnection, $_SESSION['admin'], 330, true)) {
	...
	if ($_GET['action'] == 'getTable') { /*------------ REPORT ------------*/
		...
		if (hasRows($result)) {
			...
			$html = '<tr><td colspan="4" style="text-align: center; font-size: medium; font-weight: bold;">Nenhum registro encontrado.</strong></td></tr>';
		}

		$html .= '<tr>
					<th colspan="4" align="right">Última atualização em: '.date("d/m/Y H:i").'</th>
				</tr>';
