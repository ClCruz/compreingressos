...
?>
			<tr>
				...
				<td>R$ <span><?php echo number_format($rs['VL_UNITARIO'], 2, ',', ''); ?></span></td>
...
?>
	...
	?>
	<p class="pedido_total"><b><?php echo $qtdIngressos; ?> ingresso(s)</b> para esta apresentação <span class="total">total:</span><span class="cifrao">R$</span><span class="valor"><?php echo number_format($totalIngressos+$rsPedido['VL_FRETE'], 2, ',', ''); ?></span></p>
</div>
<?php
}
?>