USE [tspweb]
GO
/****** Object:  StoredProcedure [dbo].[SP_REL_BORDERO_VENDAS]    Script Date: 04/26/2011 09:19:19 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  NumberedStoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];2    Script Date: 04/26/2011 09:19:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  NumberedStoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];3    Script Date: 04/26/2011 09:19:23 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  NumberedStoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];4    Script Date: 04/26/2011 09:19:24 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET NOCOUNT ON
	...
	SELECT	CodTipDebBordero,
		...
		TipValor
		FROM #TEMP1 UNION SELECT * FROM #TEMP2 UNION SELECT * FROM #TEMP3
	order by DebBordero'
--print @query
exec (@query4)
...
GO
/****** Object:  NumberedStoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];5    Script Date: 04/26/2011 09:19:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  NumberedStoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];6    Script Date: 04/26/2011 09:19:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  NumberedStoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];7    Script Date: 04/26/2011 09:19:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  NumberedStoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];8    Script Date: 04/26/2011 09:19:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  NumberedStoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];9    Script Date: 04/26/2011 09:19:28 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];10    Script Date: 04/26/2011 09:19:19 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  NumberedStoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];11    Script Date: 04/26/2011 09:19:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  NumberedStoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];12    Script Date: 04/26/2011 09:19:28 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  NumberedStoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];13    Script Date: 04/26/2011 09:19:23 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_REL_BORDERO_VENDAS];14    Script Date: 04/26/2011 09:19:19 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
