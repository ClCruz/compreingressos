                    ...
                    <table width="600" style="border:0;border-collapse:collapse;">
                        ...
                        <tr>
                            ...
                            <td width="520" style="padding:0;">
                                ...
                                <br/>
                                <div style="color:#000;font-size:12px;font-family:Verdana, Arial;line-height:18px;">É <b>obrigatória</b> a apresentação deste voucher no acesso ou na bilheteria do local.</div>
                            </td>
                            <td width="40" style="padding:0;"></td>
                        </tr>
                    </table>
