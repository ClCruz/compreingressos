        ...
        <script type="text/javascript">
            $(function() {
                ...
                if ($('[name=id]').val() != '') {
                    ...
                    $(":input:not(.datePicker, [name=ds_codigo], [name=qt_codigo], [type=checkbox], [type=hidden], [type=submit])").prop('disabled', true).prop('readonly', true);
                    ...
                    if ($cboPromo.val() == 4 /*BIN*/) {
                        $("input[name=limite_cpf\\[\\]]").prop('disabled', false).prop('readonly', false);
                    }
                }
