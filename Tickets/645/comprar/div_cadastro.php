		...
		<div class="coluna">
			...
			<div class="input_area nome">
				...
				<div class="inputs">
					...
					<input type="text" name="nome" id="nome" maxlength="50" placeholder="nome/name/nombre" pattern=".{1,50}" value="<?php echo utf8_encode($rs['DS_NOME']); ?>">
					<div class="erro_help">
						<p class="erro">informe seu nome</p>
						<p class="help"></p>
					</div>
					<input type="text" name="sobrenome" id="sobrenome" maxlength="50" placeholder="sobrenome/last name/apellido" pattern=".{1,50}" value="<?php echo utf8_encode($rs['DS_SOBRENOME']); ?>">
					<div class="erro_help">
			...
			<div class="input_area endereco">
				...
				<div class="inputs">
					...
					<input type="text" name="bairro" id="bairro" placeholder="bairro/district/barrio" maxlength="50" pattern=".{1,50}" value="<?php echo utf8_encode($rs['DS_BAIRRO']); ?>">
					<div class="erro_help">
