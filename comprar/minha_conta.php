...
if (isset($_SESSION['user']) and is_numeric($_SESSION['user'])) {
	...
	$query = 'SELECT DS_NOME, DS_SOBRENOME, CONVERT(VARCHAR(10), DT_NASCIMENTO, 103) DT_NASCIMENTO, DS_TELEFONE, DS_CELULAR, DS_DDD_TELEFONE, DS_DDD_CELULAR, CD_CPF, CD_RG, ID_ESTADO, DS_CIDADE, DS_BAIRRO, DS_ENDERECO, DS_COMPL_ENDERECO, CD_CEP, CD_EMAIL_LOGIN, IN_RECEBE_INFO, IN_RECEBE_SMS FROM MW_CLIENTE WHERE ID_CLIENTE = ?';
					...
					<div id="center">
						...
						<div id="center_right">
							...
							<div class="titulo with_border_bottom">
								<h1>Ol&aacute; <?php echo $rs['DS_NOME']; ?></h1>
							</div>
